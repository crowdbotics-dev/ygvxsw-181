"""
Django settings for ygvxsw_181 project.
...
WSGI_APPLICATION = 'ygvxsw_181.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ygvxsw_181 API",
    "DESCRIPTION": "API documentation for ygvxsw_181 App",
    "VERSION": "v1",
}
